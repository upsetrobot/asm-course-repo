...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; 3-08 Competency 1 Speed - Lab Solution
;;
...
studentFunction1:
    ...
    add edi, eax    ; edi = (x2 - x1)^2 + (y2 - y1)^2

    call sqrt       ; eax = sqrt((x2 - x1)^2 + (y2 - y1)^2)

    mov ecx, 60
    imul ecx        ; eax = 60 * sqrt((x2 - x1)^2 + (y2 - y1)^2)

    mov edx, 0
    idiv r8d        ; eax = 60 * sqrt((x2 - x1)^2 + (y2 - y1)^2) // t
