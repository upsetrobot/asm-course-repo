...
3-19 Strings - Test Case Adder Script.
...
case_list.cases = [
    ...
    # ;           terminator.
    Case(func_id=1, args=("hello",), ret_val=CaseArg(5, UINT32) ),
    Case(func_id=1, args=("",), ret_val=CaseArg(0, UINT32) ),
    Case(func_id=1, args=("a",), ret_val=CaseArg(1, UINT32) ),
    Case(func_id=1, args=("12345678911234567892123456789312345",), ret_val=CaseArg(35, UINT32) ),
    ...
    Case(func_id=2, args=("hello", 5, "."*255), ret_val="hello" ),
    Case(func_id=2, args=("", 0, "."*255), ret_val="" ),
    Case(func_id=2, args=("a", 1, "."*255), ret_val="a" ),
    Case(
        func_id=2, 
        args=("12345678911234567892123456789312345", 35, "."*255), 
        ret_val="12345678911234567892123456789312345" 
    ),
    ...
    Case(func_id=3, args=("hello", 5, "hello", 5), ret_val=0 ),
    Case(func_id=3, args=("hello", 5, "hell", 4), ret_val=-1 ),
    Case(func_id=3, args=("hell", 4, "hello", 5), ret_val=-1 ),
    Case(func_id=3, args=("hello", 5, "hEllo", 5), ret_val=-1 ),
    Case(func_id=3, args=("", 0, "h", 1), ret_val=-1 ),
    Case(func_id=3, args=("", 0, "", 0), ret_val=0 ),
    Case(
        func_id=3, 
        args=(
            "This is a $%$^%^$4543531354 string.", 
            35, 
            "This is a $%$^%^$4543531354 string.", 
            35
        ), 
