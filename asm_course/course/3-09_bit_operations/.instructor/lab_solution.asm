...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; 3-09 Bit Operations - Lab Solution
;;
...
studentFunction1:
    ...
    mov eax, edi            ; 0x11223344.
    rol ax, 8               ; 0x11224433.
    rol eax, 16             ; 0x44331122.
    rol ax, 8               ; 0x44332211.
...
studentFunction4:
    ...
    mov eax, esi            ; 0x11223344.
    shl eax, 16             ; 0x33440000.
    shr edi, 16             ; 0x0000aabb.
    mov ax, di              ; 0x3344aabb.
