...
APPTEST_PY_FILE_DIGEST = 'f749713bd57eecc47d8bee4adcfd13c3'
...
def main():
    ...
    output = run_test_file(APPTEST_PY_FILE_NAME)
    print(output + '\n')
...
def run_test_file(file_path: str) -> bytes:
    ...
    try:
        ...
        output = sp.check_output(["python3", file_path]).decode()
...
def test_check_output():
    ...
    assert "CONGRATULATIONS!" in run_test_file(APPTEST_PY_FILE_NAME)
