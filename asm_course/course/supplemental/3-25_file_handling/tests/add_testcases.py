...
3-25 File Handling - Test Case Adder Script.
...
# All created files start with `testing_` so they are cleaned up.
os.chdir(Path(__file__).resolve().parent.parent)
with open('testing_a.txt', 'w') as f:
    f.write('This is a file. Yayyy!\n')

case_list.add(func_id=1, args=('testing_a.txt', ), ret_val=0 )
case_list.add(func_id=1, args=('blah.txt', ), ret_val=-1 )
...
with open('testing_data.bin', 'wb') as f:
    a = [0, 1, -234, 3432523, 3223, -12323, 333, 3444, 233, 7]
    for i in a:
        f.write(struct.pack('<q', i))

case_list.add(func_id=2, args=('blah.bin', ), ret_val=0 )
case_list.add(func_id=2, args=('testing_data.bin', ), ret_val=sum(a) )
...
with open('testing_b.txt', 'w') as f:
    f.write('hello\n')

case_list.add(func_id=3, args=('Add this\n', 'testing_x.txt'), ret_val=0)
case_list.add(func_id=3, args=('Add this\n', 'testing_b.txt'), ret_val=0)
case_list.add(func_id=3, args=('Add this as well.\n', 'testing_b.txt'), ret_val=0)
