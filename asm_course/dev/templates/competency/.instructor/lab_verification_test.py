...
<Topic> - Application Test Verifier
...
TEST_CASES_DIGEST = 'd84259a811ca1a20634bc1fb0d6cb708' # *** <-- This line is mod specific
TEST_CASE_GEN_NAME = 'tests/test_case_generator.py'
TEST_CASE_GEN_DIGEST = '33d93dbb9a144045d5540bfe1478a1f2'
...
def main():
    ...
    print(sp.check_output(["make"]).decode() + '\n')
